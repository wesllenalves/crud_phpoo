...
if(isset($_POST['btCadastrar'])){
	if($objFunc->queryInsert($_POST) == 'ok'){
		header('location: http://localhost/crud_phpoo/admin/funcionario');
	}else{
...
<nav class="navbar navbar-inverse navbar-radius">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="http://localhost/login?sair=sim"><span class="glyphicon glyphicon-log-out"></span> Sair</a></li>
    </ul>
  </div>
</nav>

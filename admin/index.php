...
<nav class="navbar navbar-inverse navbar-radius">
  <div class="container-fluid">
    ...
    echo '<div class="container">
      ...
      echo '<div class="container">
        <a id="FTperfil" data-toggle="modal" data-target="#myModal"><img width="120px" height="120px" src="../upload/perfil/'.$imagem.'" /></a><br>
    </div>';  
    }
    ?>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="POST" action="../classes/enviaimagem.php"enctype="multipart/form-data">
